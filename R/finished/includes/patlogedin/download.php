...
if(isset($_POST["down-submit"])){
	echo sprintf("
		...
		<button class='btn btn-primary' onclick='printer()' style='position:relative;left:60px;padding:18px 150px 18px 150px'><strong>PRINT</strong></button>
                <button class='btn btn-primary'style='position:relative;left:70px;padding:18px 150px 18px 150px'><strong><a href='../records/%s/%s' download>DOWNLOAD</a></strong></button>
		<button class='btn btn-danger' onclick='goback()' style='position:relative;left:80px;padding:18px 150px 18px 150px'><strong>CANCEL / GO BACK</strong></button>
		</div>
