    ...
    if(!mysqli_stmt_prepare($stmt,$sql)){
    	...
    	exit();
            ...
            exit();
    			...
    			$sql="INSERT INTO doctors(docfname,doclname,docphone,docemail,doc_no_of_hospitals,doc_areas_of_specialization,password) VALUES(?,?,?,?,?,?,?)";
    			$stmt=mysqli_stmt_init($conn);
    			if(!mysqli_stmt_prepare($stmt,$sql)){
    				header("Location:../docsignup.php?error=sqlerror");
    				exit();
    				...
    				mysqli_stmt_bind_param($stmt,"sssssss",$fname,$lname,$phone,$email,$nhospitals,$areas,$hashpwd);
    				mysqli_stmt_execute($stmt);
